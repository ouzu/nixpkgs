...
let
  ...
  bootStage1 = pkgs.substituteAll {
    ...
    inherit (config.boot.initrd) checkJournalingFS verbose
      preGreetCommands preLVMCommands preDeviceCommands postDeviceCommands postMountCommands preFailCommands kernelModules;
...

{
  options = {
    ...
    boot.initrd.preGreetCommands = mkOption {
      default = "";
      type = types.lines;
      description = lib.mdDoc ''
        Shell commands to be executed before greeting.
      '';
    };
